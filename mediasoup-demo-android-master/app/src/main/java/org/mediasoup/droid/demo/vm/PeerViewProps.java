...
public abstract class PeerViewProps extends EdiasProps {
  ...
  public ObservableField<Boolean> isSpeaking = new ObservableField<>(false);

  public ObservableField<Integer> mVolume = new ObservableField<>(0);

  public ObservableField<Boolean> getIsSpeaking() {
    return isSpeaking;
  }
