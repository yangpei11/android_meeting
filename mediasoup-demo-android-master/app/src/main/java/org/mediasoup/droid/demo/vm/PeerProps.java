...
public class PeerProps extends PeerViewProps {
  ...
  public PeerProps(@NonNull Application application, @NonNull RoomStore roomStore) {
    ...
    isSpeaking.addOnPropertyChangedCallback(new Observable.OnPropertyChangedCallback() {
      @Override
      public void onPropertyChanged(Observable sender, int propertyId) {
        if (isSpeaking.get() != null) {
          System.out.println("peer is speaking: " + isSpeaking.get());
        }
      }
    });
    mStateComposer.addOnPropertyChangedCallback(
        new Observable.OnPropertyChangedCallback() {
          ...
          public void onPropertyChanged(Observable sender, int propertyId) {
            ...
            Logger.d("audioTest", audioConsumer == null?"no audio":"have audio");
